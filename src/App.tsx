      ...
      <main className="relative z-10 w-full">
        ...
        <section className="h-[200vh] relative flex flex-col items-center justify-center pointer-events-none">
            <div className="sticky top-0 h-screen flex flex-col items-center justify-center text-center px-4 w-full">
                <p className="hero-reveal text-[#b6bac5] text-xs uppercase tracking-[0.5em] mb-4 font-black border border-[#b6bac5]/20 px-4 py-2 rounded-full inline-block">
                    CREATIVE DEVELOPER & 3D ARCHITECT
                </p>
                <h1 className="hero-reveal text-6xl md:text-[12rem] font-black leading-none mb-8 text-white border-4 border-[#b6bac5]/20 px-8 py-4 rounded-2xl">
                ...
                <p className="hero-reveal text-white/60 text-sm md:text-lg max-w-xl font-light tracking-[0.2em] uppercase border border-[#b6bac5]/15 px-6 py-3 rounded-xl">
        ...
        <section id="about" className="h-[200vh] relative">
            <div className="sticky top-0 h-screen flex items-center justify-center p-8 md:p-24 overflow-hidden">
                <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-16">
                    <div>
                        <h2 className="text-5xl md:text-8xl font-black mb-8 text-white leading-none border-4 border-[#b6bac5]/20 px-6 py-3 rounded-2xl inline-block">About Me.</h2>
                        <div className="space-y-6 text-lg text-white/60 leading-relaxed font-light">
                            <p className="border border-[#b6bac5]/10 px-4 py-3 rounded-lg">I'm a creative developer passionate about building immersive web experiences and 3D interfaces.</p>
                            <p className="border border-[#b6bac5]/10 px-4 py-3 rounded-lg">Specializing in React, Three.js, and creative coding to push the boundaries of web development.</p>
                        </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                        {['React', 'Three.js', 'TypeScript', 'WebGL'].map((t, i) => (
                            <div key={i} className="p-8 border-2 border-[#b6bac5]/20 bg-[#b6bac5]/[0.05] backdrop-blur-3xl rounded-3xl group hover:border-[#b6bac5]/50 transition-all shadow-lg shadow-black/20">
                                <span className="text-[#b6bac5]/50 font-black text-xs border border-[#b6bac5]/30 px-2 py-1 rounded-full inline-block">0{i+1}</span>
                                <h3 className="text-white font-bold mt-2 border border-[#b6bac5]/15 px-3 py-1 rounded-lg text-center">{t}</h3>
                            </div>
                        ))}
                    </div>
                </div>
        ...
        <section id="projects-section" className="min-h-screen relative py-24">
            <div className="max-w-7xl mx-auto px-8">
                <div className="text-center mb-16">
                    <p className="text-[#b6bac5] text-xs uppercase tracking-[0.4em] mb-4 border border-[#b6bac5]/20 px-4 py-2 rounded-full inline-block">SELECTED PROJECTS</p>
                    <h2 className="text-4xl md:text-8xl font-black text-white mb-8 border-4 border-[#b6bac5]/20 px-6 py-3 rounded-2xl inline-block">MY WORK.</h2>
                    <p className="text-white/60 text-lg max-w-2xl mx-auto border border-[#b6bac5]/15 px-6 py-3 rounded-xl">
        ...
        <section id="contact" className="h-screen flex items-center justify-center bg-transparent p-6">
            <div className="max-w-xl w-full p-16 border-2 border-[#b6bac5]/20 bg-[#b6bac5]/[0.05] backdrop-blur-3xl rounded-[4rem] text-center relative group shadow-lg shadow-black/20">
                ...
                <h2 className="text-4xl md:text-7xl font-black text-white mb-8 border-4 border-[#b6bac5]/20 px-4 py-2 rounded-2xl inline-block">Get In Touch.</h2>
                ...
                <p className="mt-12 text-white/20 text-xs font-bold tracking-widest uppercase border border-[#b6bac5]/15 px-4 py-2 rounded-full inline-block">Open for creative opportunities.</p>
            </div>
        </section>
